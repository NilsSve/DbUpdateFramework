...
Object oCompareDatabases_vw is a dbView
    ...
    Set Icon to "DbCompareBlack2.ico"
    ...
    Object oFromFilelist_grp is a cHeaderGroup
        ...
        Set psLabel to "Select FROM Filelist.cfg"

        Object oFilelistPathFrom_fm is a cSuggestionIniForm
            Set Size to 13 413
    ...
    Object oToFilelist_grp is a cHeaderGroup
        Set Size to 43 462
        Set Location to 60 19
        Set psImage to "ActionOpenBlack.ico"
        Set psLabel to "Select TO Filelist.cfg"

        Object oFilelistPathTo_fm is a cSuggestionIniForm
            Set Size to 13 413
            Set Location to 21 25
            Set Label_Col_Offset to 0
            Set Label_Row_Offset to 1
    ...
    Object oCompareProperties_grp is a cHeaderGroup
        Set Size to 56 462
        Set Location to 112 19
        Set psImage to "SettingsBlack.ico"
        Set psLabel to "Compare Options"
    ...
    Object oReportFilename_grp is a cHeaderGroup
        Set Size to 43 462
        Set Location to 178 19
        Set psImage to "ActionPrintBlack.ico"
        Set psLabel to "Compare Report File Name"
    ...
    Procedure MainProcess
        ...
        Case Begin
            ...
            Case (iaDifferences[0] < -1)
                ...
                Send Info_Box ("Process stopped. Couldn't open table number:" * String(hTable))
                Case Break
            Case Else
    ...
    Function CompareAndOutputDiffs String sFilelistFrom String sFilelistTo tAPITableBooleans CompareCheckBoxes DateTime dtExecStart Returns Integer[]
        ...
        Boolean bIsSame bFilelistError bUserCancel bOK bCollationDiff
        Handle hTable
        ...
        Get SqlDatabaseCollationQuery of ghoDbUpdateFunctionLibrary sDatabase to sDatabaseCollationFrom
        ...
        End
        Get psDatabase of ghoDbUpdateFunctionLibrary to sDatabase
        Get SqlDatabaseCollationQuery of ghoDbUpdateFunctionLibrary sDatabase to sDatabaseCollationTo
    ...
    Procedure WriteColumnDiffs String sDriverIDFrom String sDriverIDTo Handle hTable String sLogicalTableName Boolean bIsSQLFrom Boolean bIsSQLTo tAPIColumnCompare[] aAPIColumnCompare Boolean bCompareDate_DateTime Integer iCh
        ...
        For iCount from 0 to iSize
            ...
            If (bIsSame = False) Begin
                ...
                Get MakeFromString "Name" aAPIColumnCompare[iCount].sFieldNameFrom CS_ReportDifferenceNote aAPIColumnCompare[iCount].bExistsTo to sFrom
...
//        Set Display_Error_State to True // Temp!
    ...
    Object oCompare_btn is a cButtonDPI
        Set Size to 23 58
        Set Label to "Co&mpare Databases"
        Set Location to 284 278
        Set peAnchors to anBottomRight
        Set FontWeight to fw_Bold
        Set Default_State to True
        Set psImage to "DbCompareBlack2.ico"
        ...
        Procedure DoEnable
            ...
            If (bState = False and bExists = False) Begin
                Procedure_Return
            End
            Set Enabled_State to bExists
        End_Procedure

    End_Object

    Object oViewReport_Btn is a cButtonDPI
        Set Size to 23 65
        Set Label to "View &Report"
        Set Location to 284 348
        Set peAnchors to anBottomRight
        Set MultiLineState to True
        Set psImage to "ViewReportBlack.ico"
        Set psToolTip to "Open the folder where the report was generated."
    ...
    Object oTagFilelist_Btn is a cButtonDPI
        Set Size to 23 65
        Set Label     to "&Tag Filelist Diff's"
        ...
        Procedure DoEnable
            ...
            Set Enabled_State to (SizeOfArray(iaDifferences))
        End_Procedure
